defmodule SandrabbitWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SandrabbitWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SandrabbitWeb.Gettext, "errors", msg, opts)
    end
  end
